...
### INV-UX-21 — The agent model is switchable per session, from what the agent advertises
...
- 2026-07-09 — Added INV-UX-21: the agent model is switchable per session, live,
