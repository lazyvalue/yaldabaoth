...
const DEFAULT_BINDINGS: &[DefaultBinding] = &[
    ...
    b!("ctrl-w n",          "IncreaseMasterCount", GLOBAL, "Columns", "Increase master tile count"),
    b!("ctrl-w shift-n",    "DecreaseMasterCount", GLOBAL, "Columns", "Decrease master tile count"),
