...
const DEFAULT_BINDINGS: &[DefaultBinding] = &[
    ...
    b!("ctrl-tab",          "NextTab",         GLOBAL, "Tabs & workspaces", "Next workspace"),
    b!("ctrl-shift-tab",    "PrevTab",         GLOBAL, "Tabs & workspaces", "Previous workspace"),
    b!("cmd-shift-]",       "NextTab",         GLOBAL, "Tabs & workspaces", "Next workspace"),
    b!("cmd-shift-[",       "PrevTab",         GLOBAL, "Tabs & workspaces", "Previous workspace"),
    b!("cmd-shift-right",   "NextTab",         GLOBAL, "Tabs & workspaces", "Next workspace"),
    b!("cmd-shift-left",    "PrevTab",         GLOBAL, "Tabs & workspaces", "Previous workspace"),
    b!("ctrl-1",            "GotoWorkspace1",  GLOBAL, "Tabs & workspaces", "Go to workspace 1"),
    b!("ctrl-2",            "GotoWorkspace2",  GLOBAL, "Tabs & workspaces", "Go to workspace 2"),
    b!("ctrl-3",            "GotoWorkspace3",  GLOBAL, "Tabs & workspaces", "Go to workspace 3"),
    b!("ctrl-4",            "GotoWorkspace4",  GLOBAL, "Tabs & workspaces", "Go to workspace 4"),
    b!("ctrl-5",            "GotoWorkspace5",  GLOBAL, "Tabs & workspaces", "Go to workspace 5"),
    b!("ctrl-6",            "GotoWorkspace6",  GLOBAL, "Tabs & workspaces", "Go to workspace 6"),
    b!("ctrl-7",            "GotoWorkspace7",  GLOBAL, "Tabs & workspaces", "Go to workspace 7"),
    b!("ctrl-8",            "GotoWorkspace8",  GLOBAL, "Tabs & workspaces", "Go to workspace 8"),
    b!("ctrl-9",            "GotoWorkspace9",  GLOBAL, "Tabs & workspaces", "Go to workspace 9"),
    b!("ctrl-0",            "GotoWorkspace10", GLOBAL, "Tabs & workspaces", "Go to workspace 10"),
    b!("cmd-t",             "NewTab",          GLOBAL, "Tabs & workspaces", "New tab"),
    b!("cmd-shift-w",       "CloseTab",        GLOBAL, "Tabs & workspaces", "Close tab"),
    ...
    b!("ctrl-w m",          "MoveTile",        GLOBAL, "Splits & focus", "Move tile to workspace"),
    b!("ctrl-w shift-m",    "AlsoShowTile",    GLOBAL, "Splits & focus", "Also-show tile in workspace"),
